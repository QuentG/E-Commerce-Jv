...
<body>
    ...
    <div id="resp_1" class="row">
        ...
        <div class="col-sm-3">
            <img class="img-responsive image" src="../img/xboxOne/sport/291.jpg" alt="image du jeux F1 2016 sur Xbox ONE"/>
        </div>
        <div class="col-sm-3">
            <img class="img-responsive image1" src="../img/xboxOne/sport/295.jpg" alt="image du jeux UFC Ultimate fighting championship sur Xbox ONE"/>
        </div>
        <div class="col-sm-3">
            <img class="img-responsive image1" src="../img/xboxOne/sport/301.jpg" alt="image du jeux UFC 2 sur Xbox ONE"/>
        </div>
        <div class="col-sm-3">
        ...
        <div class="col-sm-3">
            <img class="img-responsive image2" src="../img/xboxOne/sport/314.jpg" alt="image du jeux HandBall 16 sur Xbox ONE"/>
        </div>
        <div class="col-sm-3">
            <img class="img-responsive image" src="../img/xboxOne/sport/307.jpg" alt="image du jeux Madden 18 sur Xbox ONE"/>
        </div>
        <div class="col-sm-3">
            <img class="img-responsive image1" src="../img/xboxOne/sport/308.jpg" alt="image du jeux pes 2018 sur Xbox ONE"/>
        </div>
        <div class="col-sm-3">
            <img class="img-responsive image1" src="../img/xboxOne/sport/309.jpg" alt="image du jeux ShapeUp sur Xbox ONE"/>
        </div>

        <div class="col-sm-3">
            <img class="img-responsive image" src="../img/xboxOne/sport/311.jpg" alt="image du jeux Tony Hawk's pro skater 5 sur Xbox ONE"/>
        </div>
        <div class="col-sm-3">
            <img class="img-responsive image2" src="../img/xboxOne/sport/312.jpg" alt="image du jeux Le tour de France sur Xbox ONE"/>
        </div>
        <div class="col-sm-3">
